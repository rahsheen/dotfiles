...
# TODO: somehow these services are not available yet
# /usr/local/bin/tilt trigger lyra-coyote
#
# RAILS_PROJECT_PATH="$HOME/coyote"
#
...
# fi
#
# /usr/local/bin/tilt trigger coyote
#
